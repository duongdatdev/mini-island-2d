...
public class SignUpPane extends JPanel {
    ...
    //Texture
    private ImageIcon fieldTexture = new ImageIcon(SignUpPane.class.getResource("/player/1/Register/Text_Field.png"));
    private ImageIcon usernameLabelTexture = new ImageIcon(SignUpPane.class.getResource("/player/1/Register/Username_Label.png"));
    private ImageIcon emailLabelTexture = new ImageIcon(SignUpPane.class.getResource("/player/1/Register/Email.png"));
    private ImageIcon passwordLabelTexture = new ImageIcon(SignUpPane.class.getResource("/player/1/Register/Password_Label.png"));
    private ImageIcon confirmPasswordLabelTexture = new ImageIcon(SignUpPane.class.getResource("/player/1/Register/Confirm_Password.png"));
    ...
    private void init() {
        ...
        background.setIcon(new ImageIcon(SignUpPane.class.getResource("/player/1/Register/Register_Background.png")));
        ...
        signUpButton.setIcon(new ImageIcon(SignUpPane.class.getResource("/player/1/Register/Register.png")));
        backButton.setIcon(new ImageIcon(SignUpPane.class.getResource("/player/1/Register/already account click here !!.png")));
