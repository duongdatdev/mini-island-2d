...
public class SignInPane extends JPanel {
    ...
    private void init(JLabel usernameLabel, JLabel passwordLabel) {
        ...
        background.setIcon(new ImageIcon(SignInPane.class.getResource("/Login/Login_background.png")));
        ...
        usernameLabel.setIcon(new ImageIcon(SignInPane.class.getResource("/Login/Username_Label.png")));
        passwordLabel.setIcon(new ImageIcon(SignInPane.class.getResource("/Login/Password_Label.png")));

        JLabel usernameFieldTexture = new JLabel();
        usernameFieldTexture.setIcon(new ImageIcon(SignInPane.class.getResource("/Login/Text_Field.png")));

        JLabel passwordFieldTexture = new JLabel();
        passwordFieldTexture.setIcon(new ImageIcon(SignInPane.class.getResource("/Login/Text_Field.png")));
        ...
        signInButton.setIcon(new ImageIcon(SignInPane.class.getResource("/Login/Login_Button.png")));
        ...
        signUpButton.setIcon(new ImageIcon(SignInPane.class.getResource("/Login/create_account.png")));
    ...
    public static void main(String[] args) {
        ...
        SignInPane panel = new SignInPane();
