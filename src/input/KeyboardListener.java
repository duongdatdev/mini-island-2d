...
public class KeyboardListener implements KeyListener {
    ...
    private final Set<Character> currentlyPressedKeys = new HashSet<>();
    private final Set<Character> wasPressedKeys = new HashSet<>();

    private final Set<Integer> currentlyPressedKeyCodes = new HashSet<>();
